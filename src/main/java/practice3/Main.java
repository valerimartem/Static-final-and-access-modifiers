...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("Сотрудник: " + company1.getEmployeeName() + ", Компания: " + Company.companyName);
        System.out.println("Сотрудник: " + company2.getEmployeeName() + ", Компания: " + Company.companyName);
        System.out.println("Сотрудник: " + company3.getEmployeeName() + ", Компания: " + Company.companyName);
        ...
        System.out.println("Название университета: " + University.universityName);
